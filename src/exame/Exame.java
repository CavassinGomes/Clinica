...
public class Exame {
    ...
    public Exame(Integer nrExame, String solicitante, String tipo, String paciente, String medico, double peso, double altura, String convenio, String fumante, String marcaPasso) {
