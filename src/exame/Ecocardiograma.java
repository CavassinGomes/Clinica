...
public class Ecocardiograma {
    ...
    public Ecocardiograma(String avRaizAorta, String avAtrioEsq, String avVentriculoDiag, String avDiametroSist, String avDiametroDiast, String avParedePosterior, String avSeptoIntrav, String diagParedePost, String avEncurtamento, String avEjecao, String comentarios) {
    ...
    public String toString() {
        return "Ecocardiograma{" +
                "avRaizAorta='" + avRaizAorta + '\'' +
                ", avAtrioEsq='" + avAtrioEsq + '\'' +
                ", avVentriculoDiag='" + avVentriculoDiag + '\'' +
                ", avDiametroSist='" + avDiametroSist + '\'' +
                ", avDiametroDiast='" + avDiametroDiast + '\'' +
                ", avParedePosterior='" + avParedePosterior + '\'' +
                ", avSeptoIntrav='" + avSeptoIntrav + '\'' +
                ", diagParedePost='" + diagParedePost + '\'' +
                ", avEncurtamento='" + avEncurtamento + '\'' +
                ", avEjecao='" + avEjecao + '\'' +
